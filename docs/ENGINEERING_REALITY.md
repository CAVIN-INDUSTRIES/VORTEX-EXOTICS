...
**WebGL / cinematic marketing bar (separate from API pilot gate):** `docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md` §21+ (perf), §26–§27 (revenue / investor), **§28** (Cox matrix + **§28.3** automation backlog), §29–§30 (autonomy, firepower); do not confuse with tenant/RBAC correctness above.
