...
- **Elite digital presence v1** (**§0–§30** single source — WebGL §21+, VLR halt, Cox §28 / §28.3, **§29 Cursor autonomy**, **§30** `packages/3d-configurator/assets/**` + Turbo **warm-up** + Resource Arsenal + **`turbo.json`** + **`TURBO_CACHE`** / auth + **write** role): [docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md](docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md)
