  ...
  return (
    <footer className="border-t border-white/10 bg-black/40">
      <div className="shell grid gap-8 py-12 md:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
        <div>
          <p className="font-[family-name:var(--font-inter)] text-[0.72rem] uppercase tracking-[0.18em] text-[#f1d38a]">VEX Atelier</p>
          <p className="mt-3 font-[family-name:var(--font-display)] text-[1.35rem] leading-tight text-[#f5f1e8]">
        ...
        <div className="space-y-3 text-sm text-[#cfc4b2]">
          <p className="uppercase tracking-[0.12em] text-[#f1d38a]/70">Explore</p>
        ...
        <div className="space-y-3 text-sm text-[#cfc4b2]">
          <p className="uppercase tracking-[0.12em] text-[#f1d38a]/70">Company</p>
        ...
        <div className="space-y-3 text-sm text-[#cfc4b2]">
          <p className="uppercase tracking-[0.12em] text-[#f1d38a]/70">Direct</p>
          ...
          <p className="pt-2 text-xs uppercase tracking-[0.12em] text-[#9f927d]">Human-led response only</p>
        </div>
      </div>

      <div className="border-t border-white/8">
        <div className="shell flex flex-col gap-3 py-5 text-xs tracking-[0.06em] text-[#9f927d] md:flex-row md:items-center md:justify-between">
