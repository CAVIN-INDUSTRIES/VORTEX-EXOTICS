...
- **Elite digital presence v1** (**§0–§30** — WebGL §21+, VLR, Cox §28 / §28.3, **§29 autonomy**, **§30** visual assets + Turbo **warm-up** + **`TURBO_CACHE`** + troubleshooting + **`turbo.json`** + Resource Arsenal): `docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md`
