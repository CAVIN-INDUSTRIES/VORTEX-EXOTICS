...
**Marketing WebGL + luxury UX budgets (non-blocking for pilot gate):** `docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md` §21+ · Crown Jewel spec `docs/plans/2026-04-05-vex-ELITE-DIGITAL-PRESENCE-v2.0.md`.
